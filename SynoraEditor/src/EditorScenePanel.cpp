...
void EditorPanel::onScenePanelRender() {
    ...
    //     }
    //     if
    //     (ImGui::BeginDragDropTargetCustom(ImGui::GetCurrentWindow()->Rect(),
    ...
    //             std::array filters = {"*.obj", "*.fbx", "*.glb", "*.gltf",
    //             "*.mtl"}; const char *path =
    //                 tinyfd_openFileDialog("Choose a model", "",
    //                 filters.size(),
    //                                       filters.data(), "3D Model Files",
    //                                       1);
    //             if (path) {
    ...
    //         IM_ARRAYSIZE(entityName)); ImGui::Separator();
    //
    ...
    //
    //     bool opened =
    //         ImGui::TreeNodeEx(entity.getComponent<TagComp>().tag.c_str(),
    //         flags);
    //
