...
void SYN::Renderer::init(EngineContext *ctx) {
    ...
    // TextureData
    // right{loadTexture("resources/assets/SunsetSkybox/right.png")};
    ...
    // TextureData
    // front{loadTexture("resources/assets/SunsetSkybox/front.png")};
...
void Renderer::addMesh(UUID modelID, const MeshData &meshData) {
    ...
    //                               .height =
    //                               meshData.metallicRoughness->height, .type =
    //                               TextureType::rgba},
